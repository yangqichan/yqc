     ...
     <ul class="reg-login-click">
      欢迎<b style="color:red">16621217669</b>用户登录
      <div class="clearfix"></div>
     </ul><!--reg-login-click/-->
     ...
     <div class="index-pro1">
      ...
      <div class="index-pro1-list">
       <dl>
        <dt><a href="{{url('/log/goods'.$v->goods_id)}}"><img src="{{env('UPLOADS_URL')}}{{$v->goods_img}}" /></a></dt>
        <dd class="ip-text"><a href="{{url('/log/goods'.$v->goods_id)}}">{{$v->goods_name}}</a><span>已售：488</span></dd>
     ...
     <div class="prolist">
      @foreach ($img as $v)
      <dl>
       <dt><a href="{{url('/log/goods'.$v->goods_id)}}"><img src="{{env('UPLOADS_URL')}}{{$v->goods_img}}" width="100" height="100" /></a></dt>
       <dd>
        <h3><a href="{{url('/log/goods'.$v->goods_id)}}">{{$v->goods_name}}</a></h3>
